import { CORE_VERSION, REPLAY_MODE, ReplayRecorder, createGame, runReplay, step } from '@sea-invaders/core';
...
describe('core from the CommonJS build', () => {
  it('re-simulates a short run and returns its score and hash', () => {
    ...
    const recorder = new ReplayRecorder(seed, REPLAY_MODE.daily);
