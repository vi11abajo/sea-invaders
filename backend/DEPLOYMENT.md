...
`CORE_VERSION` is 10 since 2026-09-17 (10 gives every level its own fixed shuffle of silhouettes, one per wave; 9 chained them in a fixed order; 8 brings the new crab kinds, the weighted shooter, the
