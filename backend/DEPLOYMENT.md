...
`CORE_VERSION` is 13 since 2026-09-23 (13 adds the five new champions — Thick skin, Surge, Last stand, Hex, Copy — and the shared catalogue; 12 is the owner's first balance note on the deep reefs: the Gold Corsair's axe turns below Octopi's home row and the Storm Tyrant's orb sinks fast enough to cross it; 11 opens reefs 6–10: five veteran crab kinds with skills, nine silhouettes of which three living, five bosses with squads and obstacles, sixty campaign levels; 10 gives every level its own fixed shuffle of silhouettes, one per wave; 9 chained them in a fixed order; 8 brings the new crab kinds, the weighted shooter, the
